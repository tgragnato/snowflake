...
func TestFragmentBuffer_Overflow(t *testing.T) {
	...
	if !errors.Is(err, dtlserrors.ErrFragmentBufferOverflow) {
		t.Errorf("Pushing a large buffer should return an overflow error, got %v", err)
	}
}
...
func TestFragmentBuffer_TooSmall(t *testing.T) {
	...
	if !errors.Is(err, dtlserrors.ErrBufferTooSmall) {
		t.Errorf("Pushing a buffer that is smaller than fragment length should return an error, got %v", err)
	}
}
...
func TestFragmentBuffer_UnmarshalInvalid(t *testing.T) {
	...
	if err == nil {
		t.Error("Pushing a buffer with partial record layer header should return an error")
	}
	...
	if err == nil {
		t.Error("Pushing a buffer with partial handshake header should return an error")
	}
}
