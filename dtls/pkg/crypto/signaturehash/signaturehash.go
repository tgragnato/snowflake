...
func FromCertificate(cert *x509.Certificate) (Algorithm, error) {
	...
	case x509.SHA256WithRSAPSS:
		hashAlg = hash.SHA256
		sigAlg = signature.RSA_PSS_PSS_SHA256
	case x509.SHA384WithRSAPSS:
		hashAlg = hash.SHA384
		sigAlg = signature.RSA_PSS_PSS_SHA384
	case x509.SHA512WithRSAPSS:
		hashAlg = hash.SHA512
		sigAlg = signature.RSA_PSS_PSS_SHA512
...
func (a *Algorithm) Marshal() []byte {
	...
	if a.Signature.IsPSS() {
		...
		out[0] = byte(a.Hash)      // G115: TLS 1.2 hash algorithm field is defined as 1 byte.
		out[1] = byte(a.Signature) // G115: TLS 1.2 signature algorithm field is defined as 1 byte.
	}
