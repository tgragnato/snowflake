...
var (
	...
	errNoAvailableSignatureSchemes = stderrors.New("connection can not be created, no SignatureScheme satisfy this Config")
	...
	errNoAvailableCertificateSuite    = stderrors.New("connection can not be created, certificate present but no compatible CipherSuite")
	...
	ErrEmptyCertificates                = stderrors.New("certificates option requires at least one certificate")
	ErrEmptyCipherSuites                = stderrors.New("cipher suites option requires at least one cipher suite")
	ErrNilCustomCipherSuites            = stderrors.New("custom cipher suites option requires a non-nil function")
	ErrEmptySignatureSchemes            = stderrors.New("signature schemes option requires at least one scheme")
	...
	ErrNilVerifyConnection              = stderrors.New("verify connection option requires a non-nil callback")
	ErrInvalidMTU                       = stderrors.New("MTU must be positive")
	ErrInvalidReplayProtectionWindow    = stderrors.New("replay protection window must be non-negative")
	ErrEmptySupportedProtocols          = stderrors.New("supported protocols option requires at least one protocol")
	ErrEmptyEllipticCurves              = stderrors.New("elliptic curves option requires at least one curve")
	...
	ErrPskKeyExchangeModesFormat      = stderrors.New("invalid Pre-Shared Key Exchange Modes extension format")
	ErrNoPskKeyExchangeMode           = stderrors.New("no mode set for the Pre-Shared Key Exchange Modes extension")
	...
	ErrInvalidNamedCurveFatal              = errInvalidNamedCurve
	ErrCipherSuiteUnset                    = stderrors.New("server hello can not be created without a cipher suite")
	ErrCompressionMethodUnset              = stderrors.New("server hello can not be created without a compression method")
	...
	ErrCertificateListTooLong              = stderrors.New("certificate list must not be longer than 2^24-1 bytes")
	...
	ErrFingerprintHashUnavailable      = stderrors.New("fingerprint: hash algorithm is not linked into the binary")
	ErrFingerprintInvalidLength        = stderrors.New("fingerprint: invalid fingerprint length")
	ErrFingerprintInvalidHashAlgorithm = stderrors.New(
		"fingerprint: invalid hash algorithm",
	)

	ErrKeyScheduleMissingHashFunction = stderrors.New("HKDF-Extract expected a non-nil hash function")
	ErrKeyScheduleLabelTooSmall       = stderrors.New("HKDF-Expand-Label expected a label with length >= 7")
	ErrKeyScheduleLabelTooBig         = stderrors.New("HKDF-Expand-Label expected a label with length <= 255")
	ErrKeyScheduleContextTooBig       = stderrors.New("HKDF-Expand-Label expected a context with length <= 255")
	ErrKeyScheduleLengthTooBig        = stderrors.New("HKDF-Expand-Label expected a length <= 65535")
